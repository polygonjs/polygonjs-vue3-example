...
import { fetchSceneAndMount_scene_02 } from "@/polygonjs/scenes/scene_02/autogenerated/fetchSceneAndMount";
...
export default defineComponent({
  ...
  setup() {
      ...
      const loadFunction = computed(()=>fetchSceneAndMount_scene_02)
    return {
      loadFunction,
      onSceneReady,
      size
