...
export const loadSceneAsync_scene_03 = async function (options={}) {
	const {
		onProgress,
		domElement,
		configureSceneData,
	...
	const promises = [import('./loadSceneFromSceneData.js'), loadSceneData_scene_03({onProgress, sceneDataRoot})];
